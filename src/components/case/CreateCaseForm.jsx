...
export default function CreateCaseForm({ open, handleClose, onCaseCreated }) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const payload = {
        ...
        // aktenzeichen wird im Backend generiert
      ...
      if (res.erfolg) {
        ...
        setTimeout(() => {
          setFormData({
            ...
            erstParteiVorname: '', erstParteiNachname: '', erstParteiVersicherung: '', erstParteiKennzeichen: '', erstParteiFahrzeughalter: '', erstParteiKfzModell: '', erstParteiBeteiligungsposition: '',
        ...
        setError(res.nachricht || 'Fehler beim Anlegen des Falls');
      }
    } catch (err) {
      setError(err.response?.data?.nachricht || 'Fehler beim Anlegen des Falls');
    }
  };
